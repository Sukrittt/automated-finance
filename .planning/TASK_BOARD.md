...
- Goal: Phase 1 parser/extraction slice for UPI ingest accuracy.
- In scope: P1-T1 parser corpus, P1-T2 extraction KPI validation, confidence/review routing signal.
- Out of scope: UI polish, budgeting, advanced insights.
